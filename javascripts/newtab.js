...
const fireBaseConfig = {
  apiKey: "AIzaSyDwwAHNQW93RPaD3Q6qlFuQH7SPmoK44wU",
  authDomain: "shovity-noter.firebaseapp.com",
  databaseURL: "https://shovity-noter.firebaseio.com",
  projectId: "shovity-noter",
  storageBucket: "",
  messagingSenderId: "574936552766"
}
...

{
  ...
  window.noteBox.addEventListener('keyup', (event) => {
    ...
    if (target.getAttribute('editor-noteid') !== null) {
      ...
      pushState()
      const newTarget = document.querySelector(`#noteid-${noteId} textarea`)
      newTarget.focus()
